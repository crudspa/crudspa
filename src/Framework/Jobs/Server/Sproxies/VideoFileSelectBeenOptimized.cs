...
public static class VideoFileSelectBeenOptimized
{
    public static async Task<IList<VideoFile>> Execute(String connection)
    {
        await using var command = new SqlCommand();
        command.CommandText = "FrameworkJobs.VideoFileSelectBeenOptimized";
