...
{
    public static CacheControlHeaderValue NeverChanges => new()
    {
        Public = true,
    ...
    extension(HttpResponse response)
    {
        public void SetCacheHeaders(Boolean isOptimized)
        {
            ...
            if (isOptimized)
                headers.CacheControl = NeverChanges;
            else
    ...
    extension(String? fileFormat)
    {
        public String ToMimeType()
        {
            return fileFormat.HasNothing()
                ? MediaTypeNames.Application.Octet
                : GetMimeType(fileFormat.ToLower());
        }
    }

    public static String GetMimeType(String extension)
    {
        const String defaultMimeType = MediaTypeNames.Application.Octet;
    ...
    public static String GetExtension(String mimeType, Boolean throwErrorIfNotFound)
    {
        if (mimeType is null)
