create function [ContentMessaging].[SessionCanReadOrganization]
(
...
(
    ...
    where session.Id = @SessionId
        and (
            ...
            or (
                userTable.PortalId = @PortalId
                and (@OrganizationId is null or userTable.OrganizationId = @OrganizationId)
            )
        )
)