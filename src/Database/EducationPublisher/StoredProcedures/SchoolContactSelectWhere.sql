create proc [EducationPublisher].[SchoolContactSelectWhere] (
...
declare @schoolsCount int = (select count(1) from @Schools)
...
as (
    ...
    where 1 = 1
        ...
        and (@schoolsCount = 0 or schoolContact.SchoolId in (select Id from @Schools))
)
