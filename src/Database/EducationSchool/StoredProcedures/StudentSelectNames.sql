create proc [EducationSchool].[StudentSelectNames] (
...
insert into @mySchools (Id) select Id from [EducationSchool].[MySchools] (@SessionId)
...
where family.SchoolId in (select Id from [EducationSchool].[MySchools] (@SessionId))
