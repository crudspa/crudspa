create table [Content].[ContentPortal] (
    ...
    [SeoImageId] uniqueidentifier null,
    [CanonicalBaseUrl] nvarchar(250) null,
    ...
    constraint [FK_Content_ContentPortal_SeoImage] foreign key ([SeoImageId]) references [Framework].[ImageFile] ([Id]),
