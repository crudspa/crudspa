...
using ( values
    ...
    ,('add4634b-ca63-46ef-837a-db688ad32f77', 'Line Height', 'Crudspa.Content.Design.Client.Plugins.RuleType.LineHeightDesign, Crudspa.Content.Design.Client', 'Crudspa.Content.Design.Client.Plugins.RuleType.LineHeightDisplay, Crudspa.Content.Design.Client')
