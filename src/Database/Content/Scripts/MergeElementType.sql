...
using ( values
    ...
    ,('fe3d272b-8edd-486c-9d35-120fec97a8d5', 'Question',   '02b5030e-e5c2-4c18-9ddf-9a93c6d6eed5', 'Crudspa.Content.Design.Client.Plugins.ElementType.QuestionElementDesign, Crudspa.Content.Design.Client',           'Crudspa.Content.Display.Client.Plugins.ElementType.QuestionElementDisplay, Crudspa.Content.Display.Client',   'Crudspa.Content.Design.Server.Services.ElementRepositoryQuestion, Crudspa.Content.Design.Server',           0, 1, 7)
    ,('46931711-0f53-4791-9256-b0437a6c1ee6', 'Text',       'd0b01720-40fd-5c57-838a-1dce77a9b6b8', 'Crudspa.Content.Design.Client.Plugins.ElementType.TextElementDesign, Crudspa.Content.Design.Client',               'Crudspa.Content.Display.Client.Plugins.ElementType.TextElementDisplay, Crudspa.Content.Display.Client',       'Crudspa.Content.Design.Server.Services.ElementRepositoryTextElement, Crudspa.Content.Design.Server',        0, 0, 8)
    ,('dcffec78-c3da-420f-9512-a7f9e09a0fbd', 'Video',      '62766add-ea0a-5de8-9a58-96798b3b4bb9', 'Crudspa.Content.Design.Client.Plugins.ElementType.VideoElementDesign, Crudspa.Content.Design.Client',              'Crudspa.Content.Display.Client.Plugins.ElementType.VideoElementDisplay, Crudspa.Content.Display.Client',      'Crudspa.Content.Design.Server.Services.ElementRepositoryVideo, Crudspa.Content.Design.Server',              0, 1, 9)
) as Source
