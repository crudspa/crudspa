create proc [ContentDisplay].[ForumRunCommentMediaInsert] (
...
begin
    ...
    ) throw 51000, 'Comment media cannot be added.', 1;

    set @Id = newid();
    declare @now datetimeoffset(7) = sysdatetimeoffset();
    insert [Content].[CommentMedia] (Id, VersionOf, Updated, UpdatedBy, CommentId, [Type], AudioId, ImageId, PdfId, VideoId, Ordinal)
    values (@Id, @Id, @now, @SessionId, @CommentId, @Type, @AudioId, @ImageId, @PdfId, @VideoId, @Ordinal);
end