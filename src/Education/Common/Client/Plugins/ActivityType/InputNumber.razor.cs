...
public partial class InputNumber : IActivityDisplay, IDisposable
{
    ...
    public InputNumberModel Model { get; set; } = null!;
...
public class InputNumberModel : Observable
{
    public event EventHandler<Guid>? Completed;

    public InputNumberModel(Activity activity)
    {
        Activity = activity;
    ...
    public void RecordTextInput()
    {
        ...
        if (!Int32.TryParse(TextInput, out _))
            return;
