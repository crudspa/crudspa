...
public partial class ChooseText : IActivityDisplay, IDisposable
{
    ...
    public ChooseTextModel Model { get; set; } = null!;
...
public class ChooseTextModel : ChoicesModel
{
    ...
    public ChooseTextModel(IEventBus eventBus, ISoundService soundService, Activity activity)
    {
        _eventBus = eventBus;
    ...
    public async Task SelectOption(Guid? id)
    {
        ...
        if (option.State == ActivityChoiceModel.States.Valid)
