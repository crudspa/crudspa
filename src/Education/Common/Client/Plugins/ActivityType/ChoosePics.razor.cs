...
public partial class ChoosePics : IActivityDisplay, IDisposable
{
    ...
    public ChoosePicsModel Model { get; set; } = null!;
...
public class ChoosePicsModel : ChoicesModel
{
    ...
    public ChoosePicsModel(IEventBus eventBus, ISoundService soundService, Activity activity)
    {
        _eventBus = eventBus;
    ...
    public async Task SelectOption(Guid? id)
    {
        ...
        else if (option.State == ActivityChoiceModel.States.Valid)
