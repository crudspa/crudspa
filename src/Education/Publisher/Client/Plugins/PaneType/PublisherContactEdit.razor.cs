...
public partial class PublisherContactEdit : IPaneDisplay, IDisposable
{
    ...
    {
        Model = new(Path, Id, IsNew, EventBus, Navigator, PublisherContactService);
    ...
    IHandle<PublisherContactSaved>, IHandle<PublisherContactRemoved>
{
    ...
    public PublisherContactEditModel(String? path, Guid? id, Boolean isNew,
        IEventBus eventBus,
    ...
    {
        var response = await WithAlerts(() => _publisherContactService.FetchRoleNames(new()), false);
