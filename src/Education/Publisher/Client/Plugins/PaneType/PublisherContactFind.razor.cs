...
public partial class PublisherContactFind : IPaneDisplay, IDisposable
{
    ...
    public PublisherContactFindModel Model { get; set; } = null!;

    protected override async Task OnInitializedAsync()
    {
        Model = new(EventBus, ScrollService, PublisherContactService);
...
public class PublisherContactFindModel : FindModel<PublisherContactSearch, PublisherContact>,
    IHandle<PublisherContactAdded>, IHandle<PublisherContactSaved>, IHandle<PublisherContactRemoved>
{
    ...
    public PublisherContactFindModel(IEventBus eventBus, IScrollService scrollService, IPublisherContactService publisherContactService)
        : base(scrollService)
    {
    ...
    public override async Task Refresh(Boolean resetAlerts = true)
    {
        ...
        var response = await WithWaiting("Searching...", () => _publisherContactService.Search(request), resetAlerts);
