...
public partial class SchoolFindForDistrict : IPaneDisplay, IDisposable
{
    ...
    public SchoolFindForDistrictModel Model { get; set; } = null!;

    protected override async Task OnInitializedAsync()
    {
        Model = new(EventBus, ScrollService, SchoolService, Id);
...
public class SchoolFindForDistrictModel : FindModel<SchoolSearch, School>,
    ...
    IHandle<SchoolContactAdded>, IHandle<SchoolContactRemoved>
{
    ...
    public SchoolFindForDistrictModel(IEventBus eventBus, IScrollService scrollService, ISchoolService schoolService, Guid? districtId)
        : base(scrollService)
    {
    ...
    public override async Task Refresh(Boolean resetAlerts = true)
    {
        ...
        var response = await WithWaiting("Searching...", () => _schoolService.SearchForDistrict(request), resetAlerts);
