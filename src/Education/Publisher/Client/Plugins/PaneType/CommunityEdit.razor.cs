...
public partial class CommunityEdit : IPaneDisplay, IDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        Model = new(Path, Id, IsNew, districtId, EventBus, Navigator, ScrollService, CommunityService);
...
public class CommunityEditModel : EditModel<Community>,
    IHandle<CommunitySaved>, IHandle<CommunityRemoved>
{
    ...
    public CommunityEditModel(String? path, Guid? id, Boolean isNew, Guid? districtId,
        IEventBus eventBus,
