...
public partial class DistrictContactEdit : IPaneDisplay, IDisposable
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        Model = new(Path, Id, IsNew, districtId, EventBus, Navigator, DistrictContactService);
    ...
    IHandle<DistrictContactSaved>, IHandle<DistrictContactRemoved>
{
    ...
    public DistrictContactEditModel(String? path, Guid? id, Boolean isNew, Guid? districtId,
        IEventBus eventBus,
    ...
    {
        var response = await WithAlerts(() => _districtContactService.FetchRoleNames(new(new() { Id = _districtId })), false);
