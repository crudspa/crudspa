...
public static class ModuleSelectAchievements
{
    public static async Task<Module?> Execute(String connection, Guid? moduleId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "EducationStudent.ModuleSelectAchievements";
