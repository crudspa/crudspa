...
public static class TrifoldSelectAchievements
{
    public static async Task<Trifold?> Execute(String connection, Guid? trifoldId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "EducationStudent.TrifoldSelectAchievements";
