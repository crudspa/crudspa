...
public static class AssessmentAssignmentSelectForSchool
{
    public static async Task<IList<AssessmentAssignment>> Execute(String connection, Guid? sessionId, Guid? assessmentId, Guid? schoolId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "EducationDistrict.AssessmentAssignmentSelectForSchool";
