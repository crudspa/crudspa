...
public class Program
{
    public static async Task Main(String[] args)
    {
...
#if DEBUG
        const String debugLogPath = @"c:\data\temp\logs\samples-composer-.txt";
        ...
        try
        {
            ...
            mvcBuilder.PartManager.ApplicationParts.Add(new AssemblyPart(typeof(StylesController).Assembly));
            ...
            webApp.MapWhen(context => !context.Request.Path.StartsWithSegments("/api"), webAppConfig =>
                webAppConfig.UseEndpoints(endpoints => endpoints.MapFallbackToPage("/Composer")));
