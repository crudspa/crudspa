...
public class Program
{
    public static async Task Main(String[] args)
    {
...
#if DEBUG
        const String debugLogPath = @"c:\data\temp\logs\samples-consumer-.txt";
        ...
        try
        {
            ...
            webApp.MapWhen(context => !context.Request.Path.StartsWithSegments("/api"), webAppConfig =>
                webAppConfig.UseEndpoints(endpoints => endpoints.MapFallbackToPage("/Consumer")));
