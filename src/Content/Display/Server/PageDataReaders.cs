...
public static class PageDataReaders
{
    ...
    public static async Task<IList<Section>> ReadSectionsWithElements(SqlDataReader reader)
    {
        ...
        while (await reader.ReadAsync())
            textElements.Add(ReadTextElement(reader));
        ...
        while (await reader.ReadAsync())
            buttonElements.Add(ReadButtonElement(reader));
        ...
        while (await reader.ReadAsync())
            multimediaElements.Add(ReadMultimediaElement(reader));
        ...
        while (await reader.ReadAsync())
            multimediaItems.Add(ReadMultimediaItem(reader));
