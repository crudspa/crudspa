...
public static class OrganizationUsersSelect
{
    ...
    public static async Task<PopulationResult> Execute(
        String connection, Guid? sessionId, Guid? portalId, Guid organizationId)
    {
        await using var command = new SqlCommand("ContentMessaging.OrganizationUsersSelect");
