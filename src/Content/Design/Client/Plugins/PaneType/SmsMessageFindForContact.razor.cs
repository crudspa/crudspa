...
public partial class SmsMessageFindForContact : IPaneDisplay, IDisposable
{
    ...
    public SmsMessageFindForContactModel Model { get; set; } = null!;
...
public class SmsMessageFindForContactModel : FindModel<SmsMessageSearch, SmsMessage>,
    IHandle<SmsMessageAdded>, IHandle<SmsMessageSaved>, IHandle<SmsMessageRemoved>
{
    ...
    public SmsMessageFindForContactModel(IEventBus eventBus, IScrollService scrollService, ISmsMessageService smsMessageService, Guid? contactId)
        : base(scrollService)
    {
    ...
    public override async Task Refresh(Boolean resetAlerts = true)
    {
        ...
        var response = await WithWaiting("Searching...", () => _smsMessageService.SearchForContact(request), resetAlerts);
