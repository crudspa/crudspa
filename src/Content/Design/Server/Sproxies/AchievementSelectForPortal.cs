...
public static class AchievementSelectForPortal
{
    public static async Task<IList<Achievement>> Execute(String connection, Guid? sessionId, Guid? portalId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "ContentDesign.AchievementSelectForPortal";
