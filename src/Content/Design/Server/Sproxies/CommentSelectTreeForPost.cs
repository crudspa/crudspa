...
public static class CommentSelectTreeForPost
{
    public static async Task<IList<Comment>> Execute(String connection, Guid? sessionId, Guid? postId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "ContentDesign.CommentSelectTreeForPost";
