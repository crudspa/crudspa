...
public static class CommentSelect
{
    public static async Task<Comment?> Execute(String connection, Guid? sessionId, Comment comment)
    {
        await using var command = new SqlCommand();
        command.CommandText = "ContentDesign.CommentSelect";
        ...
        return await command.ExecuteQuery(connection, async reader =>
        {
            ...
            while (await reader.ReadAsync())
                comment.CommentMedias.Add(ReadCommentMedia(reader));
