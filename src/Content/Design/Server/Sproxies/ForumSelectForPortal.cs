...
public static class ForumSelectForPortal
{
    public static async Task<IList<Forum>> Execute(String connection, Guid? sessionId, Guid? portalId)
    {
        await using var command = new SqlCommand();
        command.CommandText = "ContentDesign.ForumSelectForPortal";
